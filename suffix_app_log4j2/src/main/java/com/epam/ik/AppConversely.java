...
{
    private static final File FILE_1 = new File("src/main/resources/targetFiles/first.txt");
    private static final File FILE_2 = new File("src/main/resources/targetFiles/second.txt");
